...
项目关注的不是普通文献收藏，而是将论文写作中常见的“文献—异文—论证结构”关系显式化，帮助研究者在申报、答辩和阶段性研究中展示材料如何支撑论证。
...
- 以文献、异文、章节为核心数据对象
- 以证据链绑定和关系总览作为核心展示能力
- 适合用于课程项目、创新创业项目 MVP、研究方案演示和早期原型验证

## 学术功能

- 文献资料结构化管理：记录题名、作者、年份、文献类型、出版来源、检索标识、参考文献格式和本地文件。
- 异文证据条目管理：记录篇目、传世文本、出土文本、来源材料、地域、时代、释读依据和可信度。
...
- 文献库：添加、查看、删除文献，支持上传本地文件和结构化参考文献信息。
